...
DATA_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'gen_ai_evaluator.py')
...
# ---- 封面 ----
pdf = PDF('AI评测工程师 · 定制面试题库')
pdf.set_title('AI评测工程师-定制面试题库')
pdf.set_author('AI测试面试准备')

pdf.add_page()

# 顶部深蓝横幅
pdf.set_fill_color(15, 30, 75)
pdf.rect(0, 0, 210, 55, 'F')
pdf.set_y(10)
pdf.set_font('MSYH', 'B', 26)
pdf.set_text_color(255, 255, 255)
pdf.cell(0, 14, safe_text('AI评测工程师'), align='C', new_x="LMARGIN", new_y="NEXT")
...
pdf.cell(0, 8, safe_text('专攻AI-Native / 大模型应用 / LLM评测方向'), align='C', new_x="LMARGIN", new_y="NEXT")

# 核心覆盖区
pdf.set_y(105)
pdf.set_font('MSYH', 'B', 15)
pdf.set_text_color(15, 30, 75)
pdf.cell(0, 10, safe_text('定制模块覆盖'), align='C', new_x="LMARGIN", new_y="NEXT")
pdf.ln(4)

keywords = [
    ('AutoTestHub深挖', 'LLM评测方法论', 'RAG系统评测'),
    ('Agent测试', 'Prompt安全评测', '评测指标体系'),
    ('多模型对比评测', '数据与标注管理', 'CI/CD集成'),
    ('场景题', '软技能', '面试实战'),
]
...
pdf.cell(0, 8, safe_text('专门针对AI评测/LLM评测/大模型质量方向'), align='C', new_x="LMARGIN", new_y="NEXT")
pdf.cell(0, 8, safe_text('放弃硬件/IoT赛道，聚焦纯软件AI测试核心竞争力'), align='C', new_x="LMARGIN", new_y="NEXT")
...
pdf.cell(0, 7, safe_text('目标岗位：AI评测工程师 / LLM评测工程师 / AI质量工程师'), align='C', new_x="LMARGIN", new_y="NEXT")
...
# ---- 输出 ----
PDF_FILE = os.path.join(OUTDIR, 'AI评测工程师-定制面试题库.pdf')
pdf.output(PDF_FILE)
file_size = os.path.getsize(PDF_FILE) / 1024 / 1024
print(f"\n{'='*60}")
print(f"[OK] AI评测工程师定制题库 PDF生成成功！")
print(f"  文件: {PDF_FILE}")
