# -*- coding: utf-8 -*-
"""路特创新 · AI算法测试工程师 · 定制题库 PDF生成器"""
import os, sys, datetime

DATA_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'gen_lute_custom.py')
...
# ---- 封面 ----
pdf = PDF('路特创新 · AI算法测试工程师 · 定制面试题库')
pdf.set_title('路特创新-AI算法测试工程师-定制面试题库')
...
pdf.cell(0, 12, safe_text('AI算法测试工程师 · 定制面试题库'), align='C', new_x="LMARGIN", new_y="NEXT")
...
keywords = [
    ('项目经验深挖', 'AI测试工具研发', 'Agent技术'),
    ('LLM原理评测', 'RAG系统测试', '性能与优化'),
    ('AI安全测试', '面试软技能', 'AutoTestHub复盘'),
]
...
pdf.cell(0, 8, safe_text('针对路特创新JD定制：AI测试工具研发 + Agent技术 + 智能化改造'), align='C', new_x="LMARGIN", new_y="NEXT")
...
pdf.cell(0, 7, safe_text('适用岗位：AI算法测试工程师 / 薪资35-50K·15薪 / 深圳·3-5年'), align='C', new_x="LMARGIN", new_y="NEXT")
...
# ---- 输出 ----
PDF_FILE = os.path.join(OUTDIR, '路特创新-AI算法测试工程师-定制面试题库.pdf')
pdf.output(PDF_FILE)
file_size = os.path.getsize(PDF_FILE) / 1024 / 1024
print(f"\n{'='*60}")
print(f"[OK] 路特创新定制题库 PDF生成成功！")
print(f"  文件: {PDF_FILE}")
